...
/**
 * SimplePutFindGetClientServerNC
 ...
 *
 */
public class SimplePutFindGetClientServerNC {
	...
	public SimplePutFindGetClientServerNC(int noOfThreads, int sizeOfKey_KB, int sizeOfValue_KB,int count, int findChunks){
		try{
    ...
    public static void main(String[] args) {
    	...
    	new SimplePutFindGetClientServerNC(20,1,1,1000,10);
	}
